...
const Hero = () => {
  return (
    <div className="bg-heroBg sm:bg-heromobileBg bg-cover bg-no-repeat min-h-screen h-[1277px] bg-center">
      ...
      <div className="pt-24">
        <Helmet>
          <h3 className="text-white text-xl  font-neuro flex items-center sm:text-lg">
          ...
          <h1 className="text-7xl text-white my-7 font-neuro sm:text-center sm:text-6xl sm:leading-[79px] xsm:text-5xl">
            Play, <br /> Prosper, Build
          </h1>
